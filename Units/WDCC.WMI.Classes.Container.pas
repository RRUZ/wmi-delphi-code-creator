// **************************************************************************************************
//
// Unit WDCC.WMI.Classes.Container
...
//
// The Original Code is WDCC.WMI.Classes.Container.pas.
//
...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, WDCC.Misc, Vcl.StdCtrls, Vcl.ToolWin,
  Vcl.ActnMan, Vcl.ActnCtrls, Vcl.ImgList, Vcl.ActnList, WDCC.Settings,
...
TStyleManager.Engine.RegisterStyleHook(WDCC.WMI.Classes.Container.TPageControl, TTabControlStyleHookBtnClose);
