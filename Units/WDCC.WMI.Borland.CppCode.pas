...
//
// The Original Code is WDCC.WMI.Borland.CppCode.pas.
//
...
begin
  ...
  try
    ...
    begin
      TemplateCode := '';
      StrCode := TFile.ReadAllText(GetTemplateLocation(Lng_BorlandCpp, ModeCodeGeneration,
        TWmiGenCode.WmiMethodStatic));
    end
    else
    begin
      TemplateCode := '';
      StrCode := TFile.ReadAllText(GetTemplateLocation(Lng_BorlandCpp, ModeCodeGeneration,
        TWmiGenCode.WmiMethodNonStatic));
    end;
